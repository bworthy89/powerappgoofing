...
def gen_admin():
    ...
    for k, v in [("Font","AppFont"),("Size","AppType.Small"),("Text",'"+  Add new"'),
        ...
        if k == "OnSelect":
            ...
            o.write(f"{q}OnSelect: |\n"
                    ...
                    f"{q}  Set(varAdminReturn, scrAdmin); " + P.clear_stash() + "; Navigate(scrEditForm, ScreenTransition.Cover)\n")
        else:
            prop(o, k, v, q)
    ...
    for L in LISTS:
        ...
        o.write(f"{r}OnSelect: |\n{r}  =Set(varRec{L['key']}, ThisItem);\n"
                ...
                f"{r}  Set(varAdminReturn, scrAdmin); " + P.clear_stash() + "; Navigate(scrEditForm, ScreenTransition.Cover)\n")
