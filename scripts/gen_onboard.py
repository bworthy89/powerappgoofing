...
blk(o, "OnSelect", [
    ...
    "    Set(varWizError, FirstError.Message)",
    ")"], q)
for k, v in [("Text",'"+  Add machine"'),("Fill","AppDark.Ok"),
             ("HoverFill","AppDark.Accent"),("Width","190"),
             ("X","Gutter"),("Y",str(y)),
...
for k, v in [("Text",'"Next: what is attached  >"'),("Fill","AppDark.Accent"),
             ("HoverFill","AppDark.AccentSolid"),("Width","260"),
...
for k, v in [("Text",'"No machines on this customer yet - go back a step and add one."'),
             ("Color","AppDark.Danger"),("Font","AppFont"),
...
for k, v in [("Default","ThisItem.Standard"),("Reset","varWizCompReset"),
             ("Color","AppDark.Fg"),("Font","AppFont"),("Size","AppType.Small"),
             ("Fill","AppDark.Sunken"),("CheckmarkFill","AppDark.Accent"),
             ("CheckboxBorderColor","AppDark.Line"),("PaddingLeft","8"),
             ("X","0"),("Y","2"),("Height","44"),
...
for k, v in [("Text",empty),("Color","AppDark.Muted"),("Font","AppFont"),
             ("Size","AppType.Small"),("Wrap","true"),("AutoHeight","false"),
...
for k, v in [("Text",addtxt),("Fill","AppDark.Ok"),
             ("HoverFill","AppDark.Accent"),("Width","260"),
...
for k, v in [("Text",'"Finish"'),("Fill","AppDark.Accent"),
